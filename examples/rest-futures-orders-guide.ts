...
async function start() {
  ...
  try {
    /**
     * =======
     * Credits for this guide go to user: @DKTradingClient / Code Nerd from the Kraken API Telegram group!
     * =======
     ...
     * For example:  https://api-futures.kraken.com/api/v1/contracts/XRPUSDTM  - see the "multiplier" value.
     * */
